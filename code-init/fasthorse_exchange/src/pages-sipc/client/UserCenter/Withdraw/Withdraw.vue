<template>
  <page-container class="sipc-content withdraw" :title="$t('asset.manage')">
    <h1 class="content page-head">{{$t('asset.manage')}}</h1>
    <div class="withdraw-pin">
      <div class="content-wrap-1" v-if="assets[coin]&&+assets[coin].withdraw_status">
        <div class="tab-wrap">
          <div class="tab selected">{{$t('asset.withdraw')}}{{coin}}</div>
        </div>
        ...
        <btn-once class="submit btn-main-fill" :clickFn="submit">{{$t('submit')}}</btn-once>
      </div>
      <div class="content-wrap-1">
        <div class="tab-wrap">
          <div class="tab selected">{{$t('asset.withdraw.record')}}</div>
        </div>
        <br>
...
import messages from './Withdraw.msg'
  ...
  data() {
    return {
      ...
      heads: [
        ...
        { name: 'asset', alias: 'asset', style: { textAlign: 'left' } },
