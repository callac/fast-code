...
const actions = {
  ...
  withdraw(context, { asset, address_id, amount, password, sms_code, email_code, two_step_code, address, memo }) {
  ...
  getCode(context, { username, use_type, id, img_code, country_id, validate_method }) {
    return User.sendSms({ username, use_type, id, img_code, country_id, validate_method })
  },
  ...
  createApi(context, { remark, bind_ips, sms_code, email_code, two_step_code }) {
    return User.createApi({ remark, bind_ips, sms_code, email_code, two_step_code })
  },
  updateApi(context, { user_app_id, remark, bind_ips }) {
    return User.updateApi({ user_app_id, remark, bind_ips })
  },
