<template>
  <header class="client-header transition" :class="{'home':homeHeader, 'bg': homeHeader&&homeBg}">
...
import HeaderCoins from 'components/client/HeaderCoins-zg'
import LangPin from 'components/client/LangPin-zg'
import UserPin from 'components/client/UserPin-zg'
