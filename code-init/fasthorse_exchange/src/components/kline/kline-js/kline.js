...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chart__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cname__ = __webpack_require__(16);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_mousewheel__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_tpl_html__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__view_tpl_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__view_tpl_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chart_manager__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__chart_settings__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__control__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__templates__ = __webpack_require__(7);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(Kline, [{
    key: "draw",
    value: function draw() {
      Kline.chartMgr = new __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */]();
      var view = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.parseHTML(__WEBPACK_IMPORTED_MODULE_2__view_tpl_html___default.a);

      for (var k in this.ranges) {
        var res = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(view).find('[name="' + this.ranges[k] + '"]');
        res.each(function (i, e) {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(e).attr('style', 'display:inline-block');
        });
      }

      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.element).html(view);
      this.bgColor = this.bgColor || __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_toolbar').css('background-color');
      setInterval(__WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].refreshFunction, this.intervalTime);

      if (this.type === 'stomp') {
        __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].socketConnect();
      }

      this.registerMouseEvent();
      __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.bindCanvas('main', document.getElementById('chart_mainCanvas'));
      __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.bindCanvas('overlay', document.getElementById('chart_overlayCanvas'));
      __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].refreshTemplate();
      __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].onSize(this.width, this.height);
      __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].readCookie();
      this.setTheme(this.theme);
      this.setLanguage(this.language);
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.element).css({
        visibility: 'visible'
      });
    }
  }, {
    ...
    value: function setSymbol(symbol, symbolName) {
      ...
      __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchSymbol(symbol);
    ...
    value: function setTheme(style) {
      this.theme = style;
      __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTheme(style);
    }
  }, {
    key: "setLanguage",
    value: function setLanguage(lang) {
      this.language = lang;
      __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].chartSwitchLanguage(lang);
    }
  }, {
    key: "setShowTrade",
    value: function setShowTrade(isShow) {
      ...
      if (isShow) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.trade_container').show();
      } else {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.trade_container').hide();
      }
    ...
    value: function resend() {
      ...
      this.paused = false;
      __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].requestData(true);
    }
  }, {
    key: "connect",
    ...
    value: function registerMouseEvent() {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_overlayCanvas').bind('contextmenu', function (e) {
          e.cancelBubble = true;
          e.returnValue = false;
          e.preventDefault();
          e.stopPropagation();
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.chart_container .chart_dropdown .chart_dropdown_t').mouseover(function () {
          var container = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.chart_container');
          var title = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this);
          ...
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).next().removeClass('chart_dropdown-hover');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).removeClass('chart_dropdown-hover');
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.chart_dropdown_data').mouseover(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('chart_dropdown-hover');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).prev().addClass('chart_dropdown-hover');
        }).mouseout(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).prev().removeClass('chart_dropdown-hover');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).removeClass('chart_dropdown-hover');
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_btn_parameter_settings').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_parameter_settings').addClass('clicked');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.chart_dropdown_data').removeClass('chart_dropdown-hover');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_parameter_settings').find('th').each(function () {
            var name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).html();
            var index = 0;
            var tmp = __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].get();
            var value = tmp.indics[name];
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this.nextElementSibling).find('input').each(function () {
              if (value !== null && index < value.length) {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val(value[index]);
              }
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#close_settings').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_parameter_settings').removeClass('clicked');
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.chart_container .chart_toolbar_tabgroup a').click(function () {
          __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchPeriod(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().attr('name'));
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_toolbar_periods_vert ul a').click(function () {
          __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchPeriod(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().attr('name'));
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.market_chooser ul a').click(function () {
          __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchSymbol(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name'));
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_show_tools').click(function () {
          if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).hasClass('selected')) {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTools('off');
          } else {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTools('on');
          }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_toolpanel .chart_toolpanel_button').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.chart_dropdown_data').removeClass('chart_dropdown-hover');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_toolpanel .chart_toolpanel_button').removeClass('selected');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('selected');
          var name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).children().attr('name');
          Kline.instance.chartMgr.setRunningMode(__WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].DrawingTool[name]);
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_show_indicator').click(function () {
          if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).hasClass('selected')) {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchIndic('off');
          } else {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchIndic('on');
          }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_tabbar li a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_tabbar li a').removeClass('selected');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('selected');
          var name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name');
          var tmp = __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].get();
          tmp.charts.indics[1] = name;
          __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].save();
          if (__WEBPACK_IMPORTED_MODULE_6__templates__["b" /* Template */].displayVolume === false) __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.getChart().setIndicator(1, name);else __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.getChart().setIndicator(2, name);
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_select_chart_style a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_select_chart_style a').removeClass('selected');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('selected');
          var tmp = __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].get();
          tmp.charts.chartStyle = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this)[0].innerHTML;
          __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].save();
          var mgr = __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance;
          mgr.setChartStyle('frame0.k0', __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).html());
          mgr.redraw();
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_dropdown_themes li').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_dropdown_themes li a').removeClass('selected');
          var name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name');

          if (name === 'chart_themes_dark') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTheme('dark');
          } else if (name === 'chart_themes_light') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTheme('light');
          }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_select_main_indicator a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_select_main_indicator a').removeClass('selected');
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('selected');
          var name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name');
          var tmp = __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].get();
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_toolbar_theme a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_toolbar_theme a').removeClass('selected');

          if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === 'dark') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTheme('dark');
          } else if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === 'light') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTheme('light');
          }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_select_theme li a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_select_theme a').removeClass('selected');
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_enable_tools li a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_enable_tools a').removeClass('selected');

          if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === 'on') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTools('on');
          } else if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === 'off') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].switchTools('off');
          }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_enable_indicator li a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_enable_indicator a').removeClass('selected');
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_language_setting_div li a').click(function () {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_language_setting_div a').removeClass('selected');

          if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === 'zh-cn') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].chartSwitchLanguage('zh-cn');
          } else if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === 'en-us') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].chartSwitchLanguage('en-us');
          } else if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === 'zh-tw') {
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].chartSwitchLanguage('zh-tw');
          }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).keyup(function (e) {
          if (e.keyCode === 46) {
            __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.deleteToolObject();
            __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.redraw('OverlayCanvas', false);
          }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#clearCanvas').click(function () {
          var pDPTool = __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.getDataSource('frame0.k0');
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_overlayCanvas').mousemove(function (e) {
          ...
          var x = e.clientX - r.left;
          var y = e.clientY - r.top;
          __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.onMouseDown('frame0', x, y);
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_parameter_settings :input').change(function () {
          var name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name');
          var index = 0;
          var valueArray = [];
          var mgr = __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance;
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_parameter_settings :input').each(function () {
            if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === name) {
              if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() !== '' && __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() !== null && __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() !== undefined) {
                var i = parseInt(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val());
                valueArray.push(i);
              }
          ...
          if (valueArray.length !== 0) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_parameter_settings :input').each(function () {
              if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr('name') === name) {
                if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() !== '' && __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() !== null && __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val() !== undefined) {
                  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val(value[index].getValue());
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#chart_parameter_settings button').click(function () {
          var name = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parents('tr').children('th').html();
          var index = 0;
          var value = __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.getIndicatorParameters(name);
          var valueArray = [];
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().prev().children('input').each(function () {
            if (value !== null && index < value.length) {
              __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val(value[index].getDefaultValue());
              valueArray.push(value[index].getDefaultValue());
            }

            index++;
          });
          __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.setIndicatorParameters(name, valueArray);
          var tmp = __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].get();
          tmp.indics[name] = valueArray;
          __WEBPACK_IMPORTED_MODULE_4__chart_settings__["a" /* ChartSettings */].save();
          __WEBPACK_IMPORTED_MODULE_3__chart_manager__["a" /* ChartManager */].instance.redraw('All', false);
        });

        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#sizeIcon')[0].onclick = function () {
          Kline.instance.isSized = !Kline.instance.isSized;

          if (Kline.instance.isSized) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(Kline.instance.element).css({
              position: 'fixed',
              left: '0',
              right: '0',
              top: '0',
            ...
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].onSize();
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(Kline.instance.element).attr('style', '');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('html,body').attr('style', '');
            __WEBPACK_IMPORTED_MODULE_5__control__["a" /* Control */].onSize(Kline.instance.width, Kline.instance.height);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(Kline.instance.element).css({
              visibility: 'visible',
...
function (_Theme) {
  ...
  function DarkTheme() {
    ...
    _this._colors[Theme.Color.Background] = __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.bgColor || "#0a0a0a";
...
function (_Theme2) {
  ...
  function LightTheme() {
    ...
    _this2._colors[Theme.Color.Background] = __WEBPACK_IMPORTED_MODULE_0__kline__["a" /* default */].instance.bgColor || "#fff";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__cname__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chart_settings__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__kline__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mevent__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__templates__ = __webpack_require__(7);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(Control, null, [{
    ...
    value: function clearRefreshCounter() {
      ...
      Control.refreshHandler = setInterval(Control.refreshFunction, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.intervalTime);
    }
  }, {
    key: "requestData",
    value: function requestData(showLoading) {
      Control.AbortRequest();
      window.clearTimeout(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.timer);

      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.paused) {
        return;
      }
      ...
      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.type === 'stomp' && __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient) {
    ...
    value: function requestOverStomp() {
      if (!__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.socketConnected) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient && __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.ws.readyState === 1) {
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.send(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.sendPath, {}, JSON.stringify(Control.parseRequestParam(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.requestParam)));
        return;
      }
      ...
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.timer = setTimeout(function () {
    ...
    value: function requestOverHttp() {
      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.debug) {
        console.log('DEBUG: ' + __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.requestParam);
      }

      $(document).ready(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.G_HTTP_REQUEST = $.ajax({
        type: 'GET',
        url: __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.url,
        dataType: 'json',
        data: __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.requestParam,
        timeout: 30000,
        created: Date.now(),
        beforeSend: function beforeSend() {
          this.range = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range;
          this.symbol = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.symbol;
        },
        success: function success(res) {
          if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.G_HTTP_REQUEST) {
        ...
        error: function error(xhr, textStatus, errorThrown) {
          ...
          __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.timer = setTimeout(function () {
            Control.requestData(true);
          }, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.intervalTime);
        },
        complete: function complete() {
          __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.G_HTTP_REQUEST = null;
        }
      }));
    }
  }, {
    ...
    value: function requestSuccessHandler(res) {
      ...
      if (!res || !res.success) {
        if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.type === 'poll') {
          __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.timer = setTimeout(function () {
            Control.requestData(true);
          }, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.intervalTime);
        }
      ...
      var chart = __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart();
      chart.setTitle();
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.data = eval(res.data);
      var updateDataRes = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.chartMgr.updateData('frame0.k0', __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.data.lines);
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.requestParam = Control.setHttpRequestParam(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.symbol, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range, null, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.chartMgr.getDataSource('frame0.k0').getLastDate());
      var intervalTime = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.intervalTime < __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range ? __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.intervalTime : __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range;

      if (!updateDataRes) {
        if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.type === 'poll') {
          __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.timer = setTimeout(Control.requestData, intervalTime);
        }

        return;
      }

      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.data.depths) {
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().updateDepth(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.data.depths);
      }

      Control.clearRefreshCounter();

      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.type === 'poll') {
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.timer = setTimeout(Control.TwoSecondThread, intervalTime);
      }
    ...
    value: function AbortRequest() {
      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.type !== 'stomp' || !__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient) {
        if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.G_HTTP_REQUEST && __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.G_HTTP_REQUEST.readyState !== 4) {
          __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.G_HTTP_REQUEST.abort();
        }
      }
    }
  }, {
    ...
    value: function TwoSecondThread() {
      ...
      if (f === -1) {
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.requestParam = Control.setHttpRequestParam(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.symbol, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.limit, null);
      } else {
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.requestParam = Control.setHttpRequestParam(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.symbol, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range, null, f.toString());
      }
    ...
    value: function readCookie() {
      __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
      __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].save();
      var tmp = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setChartStyle('frame0.k0', tmp.charts.chartStyle);
      var symbol = tmp.charts.symbol;

      if (!__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.init) {
        symbol = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.symbol;
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.init = true;
      }

      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.symbol = symbol;
      ...
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setMainIndicator(tmp.charts.mIndic);
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setThemeName('frame0', tmp.theme);
    ...
    value: function refreshTemplate() {
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.chartMgr = __WEBPACK_IMPORTED_MODULE_4__templates__["a" /* DefaultTemplate */].loadTemplate('frame0.k0', '');
    ...
    value: function chartSwitchLanguage(lang) {
      ...
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setLanguage(lang);
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setTitle();
      var tmp = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
      tmp.language = lang;
      __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].save();
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.onLangChange(lang);
    }
  }, {
    key: "onSize",
    value: function onSize(w, h) {
      var width = w || window.innerWidth;
      var chartWidth = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.showTrade ? width - __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.tradeWidth : width;
      var height = h || window.innerHeight;
      var container = $(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.element);
      container.css({
        width: width + 'px',
        height: height + 'px'
      });
      ...
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.redraw('All', true);
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.onResize(width, height);
    }
  }, {
    key: "mouseWheel",
    value: function mouseWheel(e, delta) {
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.scale(delta > 0 ? 1 : -1);
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.redraw('All', true);
      return false;
    }
  }, {
    ...
    value: function switchTheme(name) {
      ...
      if (name === 'dark') {
        ...
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setThemeName('frame0', 'Dark');
        var tmp = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
        tmp.theme = 'Dark';
        __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].save();
      } else if (name === 'light') {
        $('.trade_container').addClass('light').removeClass('dark');
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setThemeName('frame0', 'Light');

        var _tmp = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
      ...
      new __WEBPACK_IMPORTED_MODULE_3__mevent__["a" /* MEvent */]().raise(name);
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.redraw();
      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.onThemeChange(name);
    }
  }, {
    key: "switchTools",
    value: function switchTools(name) {
      ...
      if (name === 'on') {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance._drawingTool === __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].DrawingTool.Cursor) {
          $('#chart_Cursor').parent().addClass('selected');
        } else if (__WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance._drawingTool === __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].DrawingTool.CrossCursor) {
          $('#chart_CrossCursor').parent().addClass('selected');
        }
      } else if (name === 'off') {
        ...
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setRunningMode(__WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance._beforeDrawingTool);
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.redraw('All', true);
      }

      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.isSized) {
        Control.onSize();
      } else {
        Control.onSize(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.width, __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.height);
      }
    }
  }, {
    key: "switchIndic",
    value: function switchIndic(name) {
      ...
      if (name === 'on') {
        ...
        if (__WEBPACK_IMPORTED_MODULE_4__templates__["b" /* Template */].displayVolume === false) __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setIndicator(2, value);else __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setIndicator(2, value);
        ...
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setIndicator(2, 'NONE');

        var _tmp2 = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
    ...
    value: function switchPeriod(name) {
      ...
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.showCursor();
      Control.calcPeriodWeight(name);

      if (name === 'line') {
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().strIsLine = true;
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setChartStyle('frame0.k0', 'Line');
        __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setCurrentPeriod('line');

        var _settings = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
      ...
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().strIsLine = false;
      var p = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.tagMapPeriod[name];
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.setChartStyle('frame0.k0', __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get().charts.chartStyle);
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setCurrentPeriod(p);
      var settings = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
    ...
    value: function switchSymbolSelected(symbol) {
      ...
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart()._symbol = symbol;
      var settings = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get();
    ...
    value: function switchSymbol(symbol) {
      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.type === 'stomp' && __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.ws.readyState === 1) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.subscribed = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.subscribe(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.subscribePath + '/' + symbol + '/' + __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range, Control.subscribeCallback);
      }
      ...
      __WEBPACK_IMPORTED_MODULE_0__chart_manager__["a" /* ChartManager */].instance.getChart().setSymbol(symbol);
    }
  }, {
    key: "calcPeriodWeight",
    value: function calcPeriodWeight(period) {
      var index = period;
      if (period !== 'line') index = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.periodMap[__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.tagMapPeriod[period]];
      var periodWeight = __WEBPACK_IMPORTED_MODULE_1__chart_settings__["a" /* ChartSettings */].get().charts.period_weight;
    ...
    value: function socketConnect() {
      if (!__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient || !__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.socketConnected) {
        if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.enableSockjs) {
          var socket = new SockJS(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.url);
          __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient = Stomp.over(socket);
        } else {
          __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient = Stomp.client(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.url);
        }

        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.socketConnected = true;
      }

      if (__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.ws.readyState === 1) {
        console.log('DEBUG: already connected');
        return;
      }

      if (!__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.debug) {
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.debug = null;
      }

      __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.connect({}, function () {
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.subscribe('/user' + __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.subscribePath, Control.subscribeCallback);
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.subscribed = __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.subscribe(__WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.subscribePath + '/' + __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.symbol + '/' + __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.range, Control.subscribeCallback);
        Control.requestData(true);
      }, function () {
        __WEBPACK_IMPORTED_MODULE_2__kline__["a" /* default */].instance.stompClient.disconnect();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__exprs__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__named_object__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chart_manager__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mevent__ = __webpack_require__(15);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__exprs__ = __webpack_require__(17);
