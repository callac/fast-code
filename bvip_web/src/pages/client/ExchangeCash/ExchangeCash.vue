<template>
  <page-container v-if="siteInfo.c2cEnabled"
    ...
    <overlay v-if="modal" @click="modal=false">
      <img class="popup" :src="require('./assets/popup.png')" @click="modal=false">
    </overlay>
  </page-container>
...
<script>
import ExchangeCashForm from 'components/client/ExchangeCashForm'
...
export default {
  ...
  components: { ExchangeCashForm, MyOrder },
}
</script>
