<template>
  <page-container class="mobile-sign-up" :title="$t('password.forget')">
    <div class="mobile-page-container">
      <header class="sign-header">
        <div class="website">
          <img :src="require('assets/mobile/site.png')"/>
        </div>
        <div class="description">{{$t('down-ios-terrace')}}</div>
      </header>
      <div class="tabs">
      ...
      <div class="wrap" style="padding-bottom: 0.6rem">
        <div class="forms">
        ...
        <div class="bottom">
          ...
          <span class="tip">{{$t('account.exist')}}?
            <router-link to="/mobile/sign-up?routeType=sign-in">
      ...
      <!--<footer @click="switchAgree">-->
        ...
        <!--<button class="btn btn-green"-->
                <!--@click.stop="showOverlay='agree'">{{$t('about-us.login-agreement')}}-->
        <!--</button>-->
        <!--{{$t('and')}}-->
        <!--<button class="btn btn-green"-->
      ...
      <div class="window" style="height: 0.41rem;overflow: visible;"
...
export default {
  ...
  computed: {
    ...
    types() {
      const items = [
        { name: this.$t('phone.account'), value: 'phone' },
        { name: this.$t('email.account'), value: 'email' },
      ]
  ...
  methods: {
    ...mapActions('user', ['getCountries', 'getCode', 'resetPassword', 'getCodeImg']),
    getImgCode() {
      ...
      return this.validate(this.showItems)
        .then(() => this.resetPassword({
          ...
          .then(() => {
            ...
            this.$router.push('/mobile/sign-up?routeType=sign-in')
          }))
    },
    // 显示网易云盾
    showSms() {
  ...
  components: { MobileInput, Agreement, Privacy, HeaderMobile },
}
</script>
