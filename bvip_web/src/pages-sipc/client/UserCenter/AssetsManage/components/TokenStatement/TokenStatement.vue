  ...
  data() {
    ...
    return {
      ...
      business: {
        ...
        options: [],
        labelStyle: { ...labelStyle, width: '.6rem' },
        inputStyle: { ...inputStyle, width: '1.8rem' },
      },
      heads: [
        {
          name: 'time',
        ...
        { name: 'type', alias: 'business_desc', style: { textAlign: 'right' } },
        { name: 'asset', alias: 'asset', style: { textAlign: 'right' } },
        {
          name: 'amount',
          alias: 'change',
  ...
  watch: {
    ...
    businessTypes() {
      this.business.options = [
        { name: 'select', value: '', needTran: true },
        ...this.businessTypes,
      ]
    },
    'time.0.value'() {
